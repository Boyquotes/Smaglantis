...
onready var bodySprite = get_parent().get_node("PlayerInventoryModel/Body")
onready var hairSprite = get_parent().get_node("PlayerInventoryModel/Hair")
onready var eyesSprite = get_parent().get_node("PlayerInventoryModel/Eyes")
onready var pantsSprite = get_parent().get_node("PlayerInventoryModel/Pants")
onready var shirtSprite = get_parent().get_node("PlayerInventoryModel/Shirt")
onready var shoesSprite = get_parent().get_node("PlayerInventoryModel/Shoes")
onready var accessoriesSprite = get_parent().get_node("PlayerInventoryModel/Accessories")
onready var facialHairSprite = get_parent().get_node("PlayerInventoryModel/FacialHair")
