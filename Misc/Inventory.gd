...
onready var shirt_slot = $EquipSlots/ShirtSlot
...
func _ready():
	...
	for i in range(slots.size()):
		...
		slots[i].slot_type = SlotClass.SlotType.INVENTORY #Initializes the slot to inventory slot
...
func able_to_put_into_slot(slot):
	...
	return true #If it is a inventory slot or a hotbar slot
